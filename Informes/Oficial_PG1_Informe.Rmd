...
Al utilizar bases de datos, no utilizamos una técnica de muestreo. No obstante, la técnica
...
Luego de la limpieza, decidimos mantenernos con 11 variables que se relacionan con nuestros objetivos de investigación.
...
Comparando la anterior gráfica de los lenguajes más populares de StackOverflow, hay lenguajes que se repiten también en la otra base de datos de PLDB, como `SQL`, `JavaScript`, `HTML` entre otros.
...
Se ve que los desarrolladores que usan el lenguaje de programación de `Crystal` sufren más de memoria, mientras que los desarrolladores que usan `Groovy` son los que menos sufren memoria.
...
Se ve que los desarrolladores que usan el lenguaje de programación de `SAS` sufren más de ansiedad, mientras que los desarrolladores que usan `OCaml` son los que menos sufren ansiedad.
...
Se ve que los desarrolladores que usan el lenguaje de programación de `Lua` sufren más de problemas emocionales, mientras que los desarrolladores que usan `Ocaml` son los que menos sufren problemas emocionales.
...
Se observa que los desarrolladores que usan el lenguaje de programación de `Crystal` sufren más de problemas de autismo, mientras que los desarrolladores que usan `Groovy` son los que menos sufren problemas de autismo.
...
Se observa que los desarrolladores que usan el lenguaje de programación de `Lua` sufren más de problemas de aprendizaje, mientras que los desarrolladores que usan `COBOL` son los que menos sufren problemas de aprendizaje.
...
En este gráfico podemos visualizar
...
ggplot(tabla_larga, 
  ...
  geom_bar(stat = "identity", position = "dodge") +  # Mostrar las barras por separado
