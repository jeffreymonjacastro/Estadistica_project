...
Lenguajes **"problemáticos"**(los tres con más frecuencia en cada problema):

1.  Lua, Crystal, Erlang
2.  Lya, Ruby, SAS
3.  LISP, Lua, Erlang
4.  Rust, Lua, Crystal
5.  Assembly, Lua, APL

Total de lenguajes **"problemáticos":**
...
## Variable aleatoria: Cantidad de lenguajes de programación usados por un usuario de Stack Overflow.
