...
```{r}
write.csv(planguages, "programming_languages_limpia.csv", row.names = FALSE)
```
...
A1: Seleccionar un programador del estudio que utiliza un lenguaje de programación
A2: Seleccionar un programador del estudio que utiliza dos lenguajes de programación
...
A42: Seleccionar un programador del estudio que utiliza 42 lenguajes de programación
...
B1: Seleccionar un programador que tenga menos de 18 años
B2: Seleccionar un programador que tenga menos de 18 años
B1: Seleccionar un programador que tenga menos de 18 años
....
...
Entonces, identificamos 2 eventos: 
