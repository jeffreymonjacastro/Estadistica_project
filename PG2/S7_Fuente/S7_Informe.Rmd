...
Analizando los gráficos notaremos que son los lenguajes a los que clasificamos como **"poco problemáticos"** son los que presentan mayor número de repositorios disponibles.

Por otro lado, notaremos que son justo los lenguajes **"problematicos"** los que presentan muchisimo menos número de repositorios.
...
No se observa una relación clara entre la salud mental de los programadores y los sistemas operativos que utilizan. Aunque se presentan problemas comunes como la memoria, emocionales y de ansiedad, no se puede establecer una conexión directa entre estas variables.
...
```{r}
nrow(encuesta %>% filter(TotalLenguajes >= 6))
```
