...
### Variable Cantidad de lenguajes de Programación
...
#### Gráfico de barras de la Probabilidad vs. Salud mental
...
$|\mathbb{P}(A \cap B) - \mathbb{P}(A)*\mathbb{P}(B)| \leq 0.01$
...
-   Ansiedad: SAS Ruby Lua
    ...
    **Para nuestro primer evento E1, consideramos si un programador utiliza alguno de los lenguajes "problemáticos" y calculamos la probabilidad de este:**
...
#Hallamos la probabilidad del evento 1 E1
probE1 = sum(e1)/nrow(encuesta)
probE1
```

**Para nuestro segundo evento E2, consideramos si un programador sufre de algún problema mental y calculamos la probabilidad de este:**
...
mosaicplot(table(total$e1, total$encuesta.num_problemas_mentales), main = "Problemas mentales y lenguajes problemáticos", xlab="Evento1", ylab="Evento2")
```
...
Sacamos probabilidad de que alguien programe en JavaScript
...
Escoger una muestra de 100 programadores (con reemplazo) y contar el número de programadores que solo programen en JavaScript y que además ganen un salario mayor al promedio.
