...
```{r}
write.csv(encuesta, "survey_results_limpia.csv", row.names = FALSE)
```
...
En total tenemos `29204` observaciones para nuestro estudio.
...
A1: Seleccionar un programador del estudio que utiliza un lenguaje de programación A2: Seleccionar un programador del estudio que utiliza dos lenguajes de programación ... A42: Seleccionar un programador del estudio que utiliza 42 lenguajes de programación
...
$$
\Omega_3 = [7] - \{0\} =\{ \text{ Todas las edades del rango } \} \\
\mathcal{F_3} = 2^{|\Omega_3|} \\
\mathbb{P_3}(n) = \{ \text{ Probabilidad de que salga la edad n } \} 
$$ + Cálculo de las probabilidades de los eventos atómicos:

B1: Seleccionar un programador que tenga menos de 18 años B2: Seleccionar un programador que tenga menos de 18 años B1: Seleccionar un programador que tenga menos de 18 años ....
...
Experimento: ¿Cuál es la probabilidad que al escoger aleatoriamente a 100 programadores encuestados el 2022 (con reemplazo) el número de personas que utilizan Javascript y ganan más que el salario promedio esté entre 20 y 27, sabiendo que la probabilidad de escoger a un programador con ese lenguaje y su salario es 0.27?

```{r}
pbinom(27,100,0.27) - pbinom(19, 100, 0.27)
```
...
Se extraen 15000 programadores de una muestra de 29204, de los cuales 10492 saben programar en 6 o más lenguajes de programación. ¿Cuál es la probabilidad que el número de programadores que usan 6 o más lenguajes esté entre 5400 y 5600?

```{r}
phyper(5600, k, N-k , n) - phyper(5400 , k , N-k , n) 
```
...
Escogimos la variable salario por cantidad de problemas mentales proporcional a la edad Para el analisis de variables continuas escogimos una variación del salario de modo que este sea proporcional al rango de edad dado por los usuarios y se divida entre la cantidad de problemas mentales que tiene cada uno.
