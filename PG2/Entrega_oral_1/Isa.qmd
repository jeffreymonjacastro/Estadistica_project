...
cat("La probabilidad de que alguien sufra de ansiedad es: ", round(100*probabilidadAnsiedad,2), "%")
```
...
P_Ansiedad <- sum(encuesta$Ansiedad == TRUE) / nrow(encuesta)
P_NoAnsiedad <- sum(encuesta$Ansiedad == FALSE) / nrow(encuesta)
cat("La probabilidad de que programen en JavaScript es de:", P_JS)
cat("La probabilidad de que NO programen en JavaScript es de:", P_NoJS)
cat("La probabilidad de que sufran de ansiedad es de:", P_Ansiedad)
cat("La probabilidad de que no sufran de ansiedad es de:", P_NoAnsiedad)

P_A_given_JS <- JS_Ansiedad / sum(encuesta$JavaScript == TRUE & encuesta$Salary < quantil)
  P_B_given_JS <- JS_Ansiedad / sum((encuesta$JavaScript == TRUE & encuesta$Salary < quantil) & encuesta$Ansiedad == TRUE)
cat("La probabilidad de que sufran de ansiedad y programen en JS (ganando menos que el cuartil inferior) es de:",P_B_given_JS)
P_A_given_NoJS <- NoJS_Ansiedad / sum(encuesta$JavaScript == FALSE & encuesta$Salary > quantil)
P_B_given_NoJS <- NoJS_Ansiedad / sum((encuesta$JavaScript == FALSE & encuesta$Salary > quantil) & encuesta$Ansiedad == TRUE)
cat("La probabilidad de que no sufran de ansiedad y no programen en JS (ganando mas que el cuartil inferior) es de:",P_B_given_JS)
