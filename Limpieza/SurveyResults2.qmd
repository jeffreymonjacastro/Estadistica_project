...
# Crear columnas para cada lenguaje y asignar valores lógicos
for (nombreCol in language) {
  encuesta[[nombreCol]] <- str_detect(encuesta$LanguageHaveWorkedWith, paste0("\\b", nombreCol, "\\b"))
}
```
